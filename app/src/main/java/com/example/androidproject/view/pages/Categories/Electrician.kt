...
@Composable
fun Electrician(navController: NavController) {
    ...
    val electricians = tradesmen.filter { it.category == "Electrician" }
        ...
        Column(
            ...
            Card(
                ...
                Box(modifier = Modifier.fillMaxSize()) {
                    // Background Image
                    Image(
                        painter = painterResource(R.drawable.electricianbg),
                        contentDescription = "Electrician Background",
            ...
            Box(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Connect with certified electricians for safe and reliable electrical installations, repairs, and troubleshooting.",
                            fontSize = 16.sp,
                            color = Color.Gray,
                        ...
                        LazyColumn(
                            ...
                            items(electricians.size) { index ->
                                val trade = electricians[index]
                                ElectricianItem(trade, navController)
                            }
                        }
                    }
                }
...
@Composable
fun ElectricianItem(trade: Tradesman, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .height(150.dp)
