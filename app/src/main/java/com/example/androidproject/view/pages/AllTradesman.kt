...
import com.example.androidproject.view.pages.Categories.ACRepairItem
...
@Composable
fun AllTradesmanItem(resumes: resumesItem, navController: NavController, cardHeight: Dp,onUninterested: () -> Unit) {
