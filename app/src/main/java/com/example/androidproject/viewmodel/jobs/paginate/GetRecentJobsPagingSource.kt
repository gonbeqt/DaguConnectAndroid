...
class GetRecentJobsPagingSource(
...
) : PagingSource<Int, RecentJobs>() {
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, RecentJobs> {
    ...
    override fun getRefreshKey(state: PagingState<Int, RecentJobs>): Int? {
