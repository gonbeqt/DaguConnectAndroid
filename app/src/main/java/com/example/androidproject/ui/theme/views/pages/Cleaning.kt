...
fun Cleaning(navController: NavController) {
    val tradesmen = listOf(
        ...
        Tradesman(R.drawable.pfp, "Alex", "Electrician", "P600/hr", 4.8, R.drawable.bookmark),
        ...
        Column(
            ...
            Card(
                ...
                Box(modifier = Modifier.fillMaxSize()) {
                    // Background Image
                    Image(
                        painter = painterResource(R.drawable.cleaningbg),
                        contentDescription = "Cleaning Background",
            ...
            Box(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = "A cleaning care service provides professional cleaning for homes and businesses, including regular maintenance, deep cleaning, and specialized tasks. It ensures a clean, hygienic environment using efficient and eco-friendly products.",
                            fontSize = 16.sp,
                            color = Color.Gray,
                        ...
                        LazyColumn(
                            ...
                            items(cleanings.size) { index ->
                                val trade = cleanings[index]
                                CleaningItem(trade, navController)
                            }
                        }
                    }
                }
...
@Composable
fun CleaningItem(trade: Tradesman, navController: NavController) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .height(150.dp)
